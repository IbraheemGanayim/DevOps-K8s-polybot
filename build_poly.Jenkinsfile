                ...
                script {
                    ...
                    withCredentials([usernamePassword(credentialsId: 'GIT_CREDENTIALS_ID', passwordVariable: 'GIT_PASSWORD', usernameVariable: 'GIT_USERNAME')]) {
                        ...
                        if (!fileExists("${repoDir}/.git")) {
                            sh "git clone https://github.com/your_username/polybot-k8s.git ${repoDir}"  // Clone the Git repository if it doesn't exist
                        }
                        ...
                        dir(repoDir) {
                            ...
                            sh "sed -i 's|image: .*|image: ${ECR_REGISTRY}/team3-polybot-ecr:${IMAGE_TAG}|' polybot-deployment.yaml"  // Update image tag in deployment YAML
                            ...
                            sh 'git push https://$GIT_USERNAME:$GIT_PASSWORD@github.com/your_username/polybot-k8s.git argo-releases'
                        }
                    }
                }
            }
